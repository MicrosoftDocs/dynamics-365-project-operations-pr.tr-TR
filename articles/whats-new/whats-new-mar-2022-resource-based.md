...
description: Bu konu, kaynak/stoğu tutulmayanları temel alan senaryolar için Project Operations'ın Mart 2022 sürümünde kullanılabilen kalite güncelleştirmeleri hakkında bilgi sağlar.
author: sigitac
ms.date: 03/31/2022
ms.topic: article
ms.prod: ''
