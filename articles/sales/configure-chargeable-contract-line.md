...
description: Bu makalede, sözleşme satırlarında dahil edilen, borçlandırılabilir ve borçlandırılamayan bileşenler ayarlanması hakkında bilgiler sağlanmaktadır.
author: rumant
ms.date: 10/12/2020
ms.topic: article
