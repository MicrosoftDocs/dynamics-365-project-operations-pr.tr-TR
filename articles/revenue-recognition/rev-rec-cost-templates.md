...
description: Bu makalede, Project Operations'ta maliyet şablonlarını oluşturma ve kullanmaya yönelik bilgiler sağlanmaktadır.
author: sigitac
ms.date: 11/18/2020
ms.topic: article
...
Bu makalede, Project Operations'ta maliyet şablonlarını oluşturma ve kullanmaya yönelik bilgiler sağlanmaktadır. Maliyet şablonu şunları belirler:
