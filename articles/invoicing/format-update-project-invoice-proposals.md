...
description: Bu makalede, kaynak/stoklanmayan tabanlı senaryolar için Project Operations müşteri karşısındaki faturaları işleme hakkında ayrıntılar sağlanmaktadır.
author: sigitac
ms.date: 04/12/2021
ms.topic: article
