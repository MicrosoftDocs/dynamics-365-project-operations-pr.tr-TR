...
description: Bu makalede, Project Operations'ta işçilik maliyeti için fiyatları belirleme hakkında bilgiler yer almaktadır.
author: rumant
ms.date: 10/12/2020
ms.topic: article
...
ms.locfileid: "8926018"
---
# <a name="set-up-labor-cost-rates---lite"></a>İşçilik maliyet oranlarını ayarlama - lite
