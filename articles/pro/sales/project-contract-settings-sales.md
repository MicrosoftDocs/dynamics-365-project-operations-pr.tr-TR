---
title: Proje sözleşmeleri için üst bilgi ayrıntıları
description: Bu makale, alanlar ve Project Operations'taki proje sözleşmeleri hakkında bilgi sağlar.
author: rumant
ms.date: 03/08/2022
ms.topic: article
