---
title: Proje fırsatları için üst bilgi ayrıntıları
description: Bu makale, proje tabanlı anlaşmalar ve proje tabanlı fırsat satırları hakkında bilgi sağlar.
author: rumant
ms.date: 10/01/2020
ms.topic: article
