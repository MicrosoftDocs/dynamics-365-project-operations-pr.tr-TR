...
description: Bu makalede, Project Operations'ta proforma faturalarına yönelik bilgiler sağlanmaktadır.
author: rumant
ms.date: 04/05/2021
ms.topic: article
ms.prod: ''
...
> [!NOTE]
> Onaylanmış proforma faturalar ve fatura satırları ve fatura satırı ayrıntıları gibi ilgili kayıtlar düzenlenemez veya silinemez. 
