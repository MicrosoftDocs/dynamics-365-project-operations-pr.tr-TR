...
description: Bu makalede, Project Operations'ta nasıl yeni ortam sağlanacağı hakkında bilgiler sağlanmaktadır.
author: sigitac
ms.date: 09/13/2021
ms.topic: article
ms.prod: ''
...
Bu makalede, kaynak/stoklanmayan tabanlı senaryolar için yeni Dynamics 365 Project Operations ortamı sağlama konusunda bilgiler sağlanmaktadır.
...
5. **Dynamics 365 Finance Çift Yazma Varlık Eşlemesi** ve **Dynamics 365 Project Operations Çift Yazma Varlık Eşlemeleri** olmak üzere iki çözümü de seçin ve ardından **Uygula** seçeneğini belirleyin.
...
4. Rolün aşağıdaki varlıklar için **Okuma** ve **Sonuna ekleme** izinlerine sahip olduğunu doğrulayın:
...
3. Eşlemeleri başlatın. Daha fazla bilgi için bkz. [Project Operations çift yazma eşlemesi sürümleri](resource-dual-write-maps.md#project-operations-dual-write-maps)
4. Projeyle ilgili tüm eşlemelerin çalışıyor durumunda olduğunu doğrulayın.
