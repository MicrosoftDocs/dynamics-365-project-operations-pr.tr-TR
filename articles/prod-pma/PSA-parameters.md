...
description: Bu makalede Microsoft Dynamics 365 for Project Service Automation ile Microsoft Dynamics 365 Finance tümleştirildiğinde varsayılan verilerin nasıl girileceğini yapılandırma açıklanmaktadır.
author: ruhercul
ms.date: 03/03/2020
ms.topic: article
ms.prod: ''
