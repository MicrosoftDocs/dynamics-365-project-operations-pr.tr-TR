---
title: Proje tahminlerini doğrudan Project Service Automation'dan finans ve operasyonlara eşitleme
description: Bu makalede, doğrudan Microsoft Dynamics 365 Project Service Automation 'dan alınan proje saati tahminlerini ve proje gider tahminlerini Dynamics 365 Finance ile eşitlemek için kullanılan şablonlar ve temel görevler açıklanmaktadır.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9029829"
---
# <a name="synchronize-project-estimates-directly-from-project-service-automation-to-finance-and-operations"></a>Proje tahminlerini doğrudan Project Service Automation'dan finans ve operasyonlara eşitleme

[!include[banner](../includes/banner.md)]

Bu makalede, doğrudan Dynamics 365 Project Service Automation 'dan alınan proje saati tahminlerini ve proje gider tahminlerini Dynamics 365 Finance ile eşitlemek için kullanılan şablonlar ve temel görevler açıklanmaktadır.
...
- Yeni bir şablon oluşturuyorsanız, bu sütunu eklemeniz gerekir. Power Query'de, **Koşullu Sütun Ekle**'yi seçin ve **ModelID** gibi yeni sütun için bir ad girin. Sütun için bir koşul girin; proje görevi null değilse ardından \<enter the forecast model ID\>; diğer null'dur.
...
- Yeni bir şablon oluşturuyorsanız, bu sütunu eklemeniz gerekir. Power Query'de, **Koşullu Sütun Ekle**'yi seçin ve **ModelID** gibi yeni sütun için bir ad girin. Sütun için bir koşul girin; Tahmin satırı kimliği null değilse ardından \<enter the forecast model ID\>; diğer null'dur.
