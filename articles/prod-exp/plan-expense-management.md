...
description: Bu makalede, Microsoft Dynamics 365 Finance'ta Gider yönetimini yapılandırmadan önce planlama sürecinde değerlendirmeniz gereken noktalar ve almanız gereken kararlar açıklanmaktadır.
author: KimANelson
ms.date: 08/29/2017
ms.topic: article
ms.prod: ''
